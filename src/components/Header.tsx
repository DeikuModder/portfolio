...
const Header = () => {
  ...
  return (
    <header className="md:h-[80px] sticky top-0 left-0 bg-[#2d2d2d]/60 backdrop-blur-md py-4 md:py-0 md:px-4 flex items-center w-full z-40 shadow-lg shadow-neutral-900 headerAnimation">
      <div className="w-[20%]">
